...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='https://t.me/MzoneChat'),
                    InlineKeyboardButton('Source Code', url='https://t.me/MzoneChat')
                ]
                ]
            await query.message.edit(text="<b>Developer : <a href='https://t.me/Mzoneceo'>Master</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://t.me/MzoneChat'>Click here</a>\nUpdate Channel : <a href='https://t.me/MzoneChat'>Bot channel</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
